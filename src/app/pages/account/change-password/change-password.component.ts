...
export class ChangePasswordComponent implements OnInit {
    ...
    @ViewChild('new') password1: ElementRef;
    @ViewChild('repeat') password2: ElementRef;

    public user: User;

    constructor(private http: HttpClient, private appAuthService: AppAuthenticationService, private toastr: ToastrService, private router: Router) { }
    ...
    onSubmit(values) {
        ...
        this.http.post(environment.API_URL + "/user/" + this.user._id + "/change/password", body, {
