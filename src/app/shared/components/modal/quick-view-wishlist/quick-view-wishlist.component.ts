...
@Component({
  selector: 'app-quick-view-wishlist',
  templateUrl: './quick-view-wishlist.component.html',
  styleUrls: ['./quick-view-wishlist.component.scss']
})
export class QuickViewWishlistComponent implements OnInit, OnDestroy {

  @Input() product: Product;
  @ViewChild("quickViewWishlist", { static: false }) QuickView: TemplateRef<any>;
  ...
  addToWishlist() {
    console.log("Add to wishlit clicked");
